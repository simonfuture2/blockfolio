const Social = () => {
    return (
        <div className="social & dLinks">
            <h2>Socials</h2>

            <a href="https://twitter.com/simonfuture2/" target="_blank" className="button">Twitter</a>
            <a href="https://www.linkedin.com/in/simonfuture" target="_blank" className="button">LinkedIn</a>
            <a href="https://github.com/simonfuture2" target="_blank" className="button">GitHub</a>
