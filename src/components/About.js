       ...
       and is willing to provide the capital for high-level performance.
        ...
        <iframe allowfullscreen="allowfullscreen" src="https://designrr.page?id=236006&token=348591333&type=FP&h=3856" height="300" width="500" frameborder="0"></iframe>
            ...
            Blockchain Developer Bootcamp
                ...
                Capstone Project: <li>Smoke Test, Smart Contract Tests, Transfer Tokens, Delegated Token
                    Transfers, Building the Exchange, Withdraws, Redux, Selectors, Trades, Order Book, My Transactions, Price Chart, Cancel Orders, Fill Orders, Deposits, Create Orders, Deploy Contracts, Deploy UI
                </li>
                <li>Intro to Blockchain</li>
                <li>Intro to Ethereum</li>
                <li>Intro to Cryptography</li>
                <li>Intro to Wallets</li>
                <li>Intro to Dapps</li>
                <li>Intro to Smart Contracts</li>
                <li>Intro to Web3.js</li>
                <li>Intro to Ethereum Tokens</li>
            ...
            Blockchain Mastery University
                    ...
                    <li>Flash loans</li>
                    <li>Defi for Developers</li>
                    <li>Intro to Chainlink</li>
                    <li>Intro to Uniswap</li>
                    <li>Forking Ethereum Mainnet w/ Ganache-CLI</li>
                    <li>Intro to Arbitrage Trading</li>
                    <li>0x Exchange Protocol</li>
                    <li>Intro to DyDx</li>
                    <li>Intro to Aave Flash Loans</li>
                    <li>Intro to Ethers.js</li>
                    <li>Build Real-time DeFi Analytics Dashboard</li>
                    <li>Create D-Web App w/ IPFS</li>
                    <li>Deploy Dapp w/ IPFS</li>
                    <li>Code Dapp Wallet</li>
                    <li>Smart Contract Dev. w/ Hardhat</li>
                    <li>Intro to Vyper & Brownie Smart Contract Dev.</li>
                    <li>Advanced Dapp Dev. w/ Web3-React</li>
                    <li>How to deploy Dapp to Binance Smart Chain</li>
